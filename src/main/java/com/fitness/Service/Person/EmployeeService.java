...
public class EmployeeService {
    ...
    private Employee makeCustomer(TextField nameTextField, TextField surnameTextField, TextField phoneTextField, TextField phone2TextField, TextField addressTextField, ComboBox<Offer> offerComboBox, ComboBox<Position> positionComboBox){
        ...
        if(     Verify.name(name, nameTextField) &&
                ...
                Verify.offer(offer, offerComboBox) &&
            ...
            employee.setOffer(offer);
            employee.setPosition(position);
        }
        return employee;
    }

    public boolean add(TextField nameTextField, TextField surnameTextField, TextField phoneTextField, TextField phone2TextField, TextField addressTextField, ComboBox<Offer> offerComboBox, ComboBox<Position> positionComboBox){
    ...
    public boolean edit(TextField nameTextField, TextField surnameTextField, TextField phoneTextField, TextField phone2TextField, TextField addressTextField, ComboBox<Offer> offerComboBox, ComboBox<Position> positionComboBox){
        Employee employee = this.makeCustomer(nameTextField, surnameTextField, phoneTextField, phone2TextField, addressTextField, offerComboBox, positionComboBox);
